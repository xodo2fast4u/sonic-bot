...
export interface SendUtils {
  ...
  mention: (sonic: WhatsAppSocket, msg: WhatsAppMessage, text: string, mentions: string[]) => Promise<void>
  ...
  image: (sonic: WhatsAppSocket, msg: WhatsAppMessage, url: string, caption?: string) => Promise<void>
}
